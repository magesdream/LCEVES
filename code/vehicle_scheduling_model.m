...
%             -----------------------------------------
            ...
            exp_P = (p1~=p2)*expK;
            %总体计算
            objvalue(m) = objvalue(m) + ds+exp_P;
        end
%        道路拥挤量评价
...
% 
% ca3 = hist(expect_pop,shLength);
% ca_ex3 = ca3-shCapacity';
% caExp3 = ca_ex3(ca_ex3>0);
% cap_eval3 = caExp3;
% 
% 
% endArr = [];
...
% 
% exp_eval_f2 = find(exp_eval2==0);
% 
% ca2 = hist(capArr2,shLength);
% ca_ex2 = ca2-shCapacity';
% caExp2 = ca_ex2(ca_ex2>0);
% cap_eval2 = caExp2;
